...
type OutlierDetectionLoadBalancingConfig struct {
	...
	BaseEjectionTime *duration.Duration `protobuf:"bytes,2,opt,name=base_ejection_time,json=baseEjectionTime,proto3" json:"base_ejection_time,omitempty"`
	...
	MaxEjectionTime *duration.Duration `protobuf:"bytes,3,opt,name=max_ejection_time,json=maxEjectionTime,proto3" json:"max_ejection_time,omitempty"`
...
func (x *OutlierDetectionLoadBalancingConfig) GetInterval() *duration.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
func (x *OutlierDetectionLoadBalancingConfig) GetBaseEjectionTime() *duration.Duration {
	if x != nil {
...
func (x *OutlierDetectionLoadBalancingConfig) GetMaxEjectionTime() *duration.Duration {
	if x != nil {
...
type GrpcLbConfig struct {
	...
	InitialFallbackTimeout *duration.Duration `protobuf:"bytes,3,opt,name=initial_fallback_timeout,json=initialFallbackTimeout,proto3" json:"initial_fallback_timeout,omitempty"`
}
...
func (x *GrpcLbConfig) GetInitialFallbackTimeout() *duration.Duration {
	if x != nil {
...
type XdsServer struct {
	...
	ServerFeatures []*protobuf.Value `protobuf:"bytes,3,rep,name=server_features,proto3" json:"server_features,omitempty"`
}
...
func (x *XdsServer) GetServerFeatures() []*protobuf.Value {
	if x != nil {
...
type XdsServer_ChannelCredentials struct {
	...
	Config *protobuf.Struct `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"` // Optional JSON config.
}
...
func (x *XdsServer_ChannelCredentials) GetConfig() *protobuf.Struct {
	if x != nil {
		return x.Config
	}
	return nil
...
var file_grpc_service_config_service_config_proto_goTypes = []interface{}{
	...
	(*protobuf.Value)(nil),                                                 // 40: google.protobuf.Value
	(*wrapperspb.StringValue)(nil),                                         // 41: google.protobuf.StringValue
	(code.Code)(0),                                                         // 42: google.rpc.Code
	(*protobuf.Struct)(nil),                                                // 43: google.protobuf.Struct
}
