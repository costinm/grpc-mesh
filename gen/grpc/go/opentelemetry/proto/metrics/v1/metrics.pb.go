...
const (
	...
	// value was reset (e.g. MetricReader).
...
const (
	...
	// for an equivalent to the MetricReader "staleness marker".
...
// a MetricReader (see: https://prometheus.io/docs/concepts/metric_types/#summary)
