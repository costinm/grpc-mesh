...
// period.
const (
	// EchoTestServiceEchoProcedure is the fully-qualified name of the EchoTestService's Echo RPC.
	EchoTestServiceEchoProcedure = "/proto.EchoTestService/Echo"
	// EchoTestServiceForwardEchoProcedure is the fully-qualified name of the EchoTestService's
	// ForwardEcho RPC.
	EchoTestServiceForwardEchoProcedure = "/proto.EchoTestService/ForwardEcho"
)
...
func NewEchoTestServiceHandler(svc EchoTestServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	echoTestServiceEchoHandler := connect_go.NewUnaryHandler(
		EchoTestServiceEchoProcedure,
		svc.Echo,
		opts...,
	)
	echoTestServiceForwardEchoHandler := connect_go.NewUnaryHandler(
		EchoTestServiceForwardEchoProcedure,
		svc.ForwardEcho,
		opts...,
	)
	return "/proto.EchoTestService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		case EchoTestServiceEchoProcedure:
			echoTestServiceEchoHandler.ServeHTTP(w, r)
		case EchoTestServiceForwardEchoProcedure:
			echoTestServiceForwardEchoHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
