...
func NewOperationsHandler(svc OperationsHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	operationsListOperationsHandler := connect_go.NewUnaryHandler(
		OperationsListOperationsProcedure,
		svc.ListOperations,
		opts...,
	)
	operationsGetOperationHandler := connect_go.NewUnaryHandler(
		OperationsGetOperationProcedure,
		svc.GetOperation,
		opts...,
	)
	operationsDeleteOperationHandler := connect_go.NewUnaryHandler(
		OperationsDeleteOperationProcedure,
		svc.DeleteOperation,
		opts...,
	)
	operationsCancelOperationHandler := connect_go.NewUnaryHandler(
		OperationsCancelOperationProcedure,
		svc.CancelOperation,
		opts...,
	)
	operationsWaitOperationHandler := connect_go.NewUnaryHandler(
