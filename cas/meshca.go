...
import (
	...
	meshca "github.com/costinm/grpc-mesh/gen/grpc-go/google/security/meshca/v1"
)

type GoogleCAClient struct {
	client   meshca.MeshCertificateServiceClient
...
func NewGoogleCAClient(endpoint string, creds credentials.PerRPCCredentials) (*GoogleCAClient, error) {
	...
	conn, err := grpc.Dial(endpoint, ol...)
	if err != nil {
